...
# print('John\'s home')  "\"dan sonra gelen karekter stringi bitiren değil alalede bir kesme işareti demektir.

print("""hi
world""") 
#Parentez içerisine üç tırnak koyup istediğin satıra boşluklu yazdırabilirsin.
...
# .starswith("") kesme ifadesine yazdığınız şeyin true ya da false olduğunu gösterir.Metnin neyle basladığını gösterir.

print(mesaj1.endswith("a"))
#.endswith("") kesme ifadesine yazdığınız şeyin true ya da false olduğunu gösterir.Metnin neyle bittiğini gösterir.
